...
import AttackBlock from "./Items/AttackBlock";  // Seems unused, consider removing if not necessary
import Digest from "./Digest";  // Seems unused, consider removing if not necessary

export default function Home() {
    // Scroll to the 'home--2' section
    ...
    return (
        <div>
            <div className="flex-col md:flex-row flex justify-around mt-8 sm:mt-16 font-['Work_Sans']">
                ...
                {/* Information Section */}
                <div className="text-black ml-8 mt-8">
                    <p className="text-3xl sm:text-6xl font-bold">Discover </p>
                    <p className="text-3xl sm:text-6xl sm:mt-[3px] font-bold">Graphical Password</p>
                    <p className="text-3xl sm:text-6xl sm:mt-[3px] font-bold">Authentication</p>
    ...
    className="transition duration-500 ease-in-out sm:w-1/3 bg-gradient-to-r from-[#FF6F61] to-[#D32F2F] text-white rounded-lg px-4 py-1 mt-6 sm:text-xl border-none hover:bg-gradient-to-r hover:from-[#D32F2F] hover:to-[#FF6F61]"
    aria-label="Know more about Graphical Password Authentication">
         ...
         Know More
            ...
            {/* <div id="home--2" className="sm:mt-48 font-['Work_Sans']">
                <div className="ml-6 sm:ml-28 pt-24">
                    <p className="text-3xl sm:text-5xl font-bold">Resistance To Attacks</p>
