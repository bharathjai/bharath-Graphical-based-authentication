...
export default function Footer(props) {
    ...
    return (
        <div className="bg-[#3B3B3B]">
            <div className="bg-[#3B3B3B] mt-24 flex justify-around flex-col sm:flex-row">
                ...
                <div className="ml-4 sm:ml-12 mt-6">
                    <div className="flex">
                        ...
                        <p className="sm:text-xl text-white ml-2 font-['Roboto']">Graphical Password Auth</p>
                    </div>
                ...
                <div className="ml-4 sm:ml-0 text-white mt-6">
                    <p className="font-['Roboto'] sm:text-xl">Explore</p>
                ...
                <div className="hidden sm:block text-white mt-6">
                    <p className="font-['Roboto'] text-xl">Join Our Monthly Digest</p>
                    <p className="text-gray-300 font-['Roboto'] mt-4">Get Exclusive Promotions & Updates.</p>
            ...
            <p className="mt-2 text-[#9b9b9b] sm:text-md text-sm text-center pb-4"> SAY MY NAME</p>
        </div>
